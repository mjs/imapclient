...
class TestParseFetchResponse(unittest.TestCase):
                    ...
                    respType: (
                        [
                            (
                                ...
                                b"alternative",
                                (b"boundary", b"===============8211050864078048428=="),
                                None,
                                None,
                                None,
                            ),
                            (
                                ...
                                1,
                                None,
                                (b"attachment", (b"filename", b"attachment.txt")),
                                None,
                                None,
                            ),
                        ],
                        b"mixed",
                        (b"boundary", b"===============0373402508605428821=="),
                        None,
                        None,
                        None,
                    ),
    ...
    def test_Address_str(self):
        self.assertEqual(
            str(Address(b"Mary Jane", None, b"mary", b"jane.org")),
            "Mary Jane <mary@jane.org>",
        )

        self.assertEqual(
            str(Address("Mary Jane", None, "mary", "jane.org")),
            "Mary Jane <mary@jane.org>",
        )

        self.assertEqual(
            str(Address("Anonymous", None, "undisclosed-recipients", None)),
            "Anonymous <undisclosed-recipients>",
        )

        self.assertEqual(
            str(Address(None, None, None, "undisclosed-recipients")),
    ...
    def test_Address_str_ignores_encoding_error(self, mock_logger):
        self.assertEqual(
            str(
                Address(
                    b"Russian \xc2\xeb\xe0\xe4\xe8\xec\xe8\xf0",
                    None,
                    b"g\xe9rard",
                    "domain.org",
                )
